#ifndef RICE_DECOMPRESSION_H
#define RICE_DECOMPRESSION_H
...
////////////////////////////////////////////////////////////////////////
///	Class to perform packet-level Rice decompression
...
private:
	...
	{
		MAX_EXT2=7,
		MAX_EXT2_SUM=MAX_EXT2*(MAX_EXT2+1)/2 + MAX_EXT2
	};
	enum
	{
	...
	enum{INPUT_BUFFER_SIZE=16*1024};
	enum{OUTPUT_BUFFER_SIZE=16*1024};
	enum
	{
        MSB_OPTION_MASK				 =16,
        NN_OPTION_MASK				 =32
